...
class box(physObject):
	...
	def updateBounds(self):
		...
		self.topLeft=vecF.sfVec((self.center[0]-(self.box.size[0]/2),self.center[1]-(self.box.size[1]/2)))
		self.bottomRight=vecF.sfVec((self.center[0]+(self.box.size[0]/2),self.center[1]+(self.box.size[1]/2)))
...
class circle(physObject):
	...
	def updateBounds(self):
		...
		self.topLeft=vecF.sfVec((self.center[0]-self.circle.radius,self.center[1]-self.circle.radius))
		self.bottomRight=vecF.sfVec((self.center[0]+self.circle.radius,self.center[1]+self.circle.radius))
	def changeColor(self,nColor):
